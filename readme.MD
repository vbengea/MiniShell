...
* Nice to have
	...
	- Flag en redireccion cuando el heredoc viene entre comillas dobles.
...
* Solved issues
	...
	- Gestionar entornos diferentes para export y env.
...
n running in a subshell, the child becomes the parent so it must replicate the signal handling. 

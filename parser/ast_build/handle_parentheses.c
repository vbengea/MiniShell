...
/*   Updated: 2025/02/15 19:21:10 by vbengea          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/headers.h"

static void handle_redirection_after_paren(t_ast_node *group_node, t_token **next_after_paren)
{
...
t_ast_node *handle_parentheses(t_token *tokens)
{
	...
	if (context.next_after_paren && is_valid_operator(context.next_after_paren->type))
